...
import projectktp.projectktp.exceptions.NonexistentEntityException;
import projectktp.projectktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("projectktp_projectktp_jar_0.0.1-SNAPSHOTPU");
